...
br.getPageURI = function(index, reduce, rotate) {
    ...
    var url = 'http://hydrastg.library.cornell.edu/fedora/get/scott:7035_' + imgStr + '/digitalImage';
    return url;
}
...
br.bookTitle= "State v. Patterson. Supreme Court of Alabama.  Brief for appellant. 40 p. [in pencil: 36 or 37]";
...
br.bookUrl  = '/scottsboro/catalog/scott:7035';
