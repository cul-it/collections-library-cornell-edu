...
br.getPageURI = function(index, reduce, rotate) {
    ...
    var url = 'http://hydrastg.library.cornell.edu/fedora/get/scott:7040_' + imgStr + '/digitalImage';
    return url;
}
...
br.bookTitle= "Weems v. State, 236 Ala. 261 (1938).  Decision, Supreme Court of Alabama.";
...
br.bookUrl  = '/scottsboro/catalog/scott:7040';
