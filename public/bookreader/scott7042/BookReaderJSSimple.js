...
br.getPageURI = function(index, reduce, rotate) {
    ...
    var url = 'http://hydrastg.library.cornell.edu/fedora/get/scott:7042_' + imgStr + '/digitalImage';
    return url;
}
...
br.bookTitle= "Norris v. State, 236 Ala. 281 (1938).  Decision, Supreme Court of Alabama.";
br.bookAuthor= "Alabama, Supreme Court";
br.bookPub= "Unknown: , June 16, 1938";
...
br.bookUrl  = '/scottsboro/catalog/scott:7042';
