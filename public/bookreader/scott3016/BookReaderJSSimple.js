...
br.getPageURI = function(index, reduce, rotate) {
    ...
    var url = 'http://hydrastg.library.cornell.edu/fedora/get/scott:3016_' + imgStr + '/digitalImage';
    return url;
}
...
br.bookTitle= "Decision on motion for a new trial, Judge Horton.  June 22, 1933. 17 p.";
br.bookAuthor= "Morgan County, Circuit Court";
br.bookPub= "Decatur, AL.: , June 22, 1933";
...
br.bookUrl  = '/scottsboro/catalog/scott:3016';
