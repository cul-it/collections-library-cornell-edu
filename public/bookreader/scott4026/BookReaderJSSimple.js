...
br.getPageURI = function(index, reduce, rotate) {
    ...
    var url = 'http://hydrastg.library.cornell.edu/fedora/get/scott:4026_' + imgStr + '/digitalImage';
    return url;
}
...
br.bookTitle= "Patterson v. Alabama. October term 1934.  Petition and brief in support of application for certiorari. 52 p";
...
br.bookUrl  = '/scottsboro/catalog/scott:4026';
